...
AFTER CLASS CHECK SKIM & COLUMN CHANGES FOR litter_data and pups_data
```{r}
...
Read in SAS AFTER CLASS REVIEW HOW TO DO THIS
```{r}
pulse_data = haven::read_sas
```

EXPORT DATA, CHECK HOW TO DO THIS AFTER CLASS
